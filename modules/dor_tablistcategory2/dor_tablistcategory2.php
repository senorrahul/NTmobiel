...
class dor_tablistcategory2 extends Module {
    ...
    public function hookHome(){
        ...
        if($defaultTabID != -1){
            return $this->display(__FILE__, 'dor_tablistcategory2.tpl', $this->getCacheId());
        }else{
            return $this->display(__FILE__, 'dor_tablistcategory2_all.tpl', $this->getCacheId());
        }
    }
    ...
    public function DorCacheTablist2($mainCateID, $cateID,$defaultTabID, $productTabslider){
        ...
        $fileCache = 'HomeTabList2Caches-Shop'.$id_shop.'-'.$cateID;
    ...
    public function hookAjaxCall($params)
    {
        ...
        if(isset($_POST['cateID']) && $_POST['cateID'] != ""){
            ...
            if($page > 0){
                $varsData = $this->display(__FILE__, '/views/templates/hook/product-field.tpl', $this->getCacheId());
            }else{
