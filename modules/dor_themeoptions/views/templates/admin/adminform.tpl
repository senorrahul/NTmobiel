    ...
    <div class="row">
                                ...
                                <div class="form-group" id="themeColorOption">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout1{if $dorthemecolor=='color1' } active {/if} "id="color1"><a href="javascript:void(0)"  title="{l s='color1'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout2{if $dorthemecolor=='color2' } active {/if}" id="color2"><a href="javascript:void(0)"  title="{l s='color2'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout3 {if $dorthemecolor=='color3' } active {/if}" id="color3"><a href="javascript:void(0)"  title="{l s='color3'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout4 {if $dorthemecolor=='color4' } active {/if}" id="color4"><a href="javascript:void(0)"  title="{l s='color4'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout5 {if $dorthemecolor=='color5' } active {/if}" id="color5"><a href="javascript:void(0)"  title="{l s='color5'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout6 {if $dorthemecolor=='color6' } active {/if}"  id="color6"><a href="javascript:void(0)" title="{l s='color6'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout7 {if $dorthemecolor=='color7' } active {/if}" id="color7"><a href="javascript:void(0)"  title="{l s='color7'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout8 {if $dorthemecolor=='color8' } active {/if}"  id="color8"><a href="javascript:void(0)" title="{l s='color8'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout9 {if $dorthemecolor=='color9' } active {/if}" id="color9"><a href="javascript:void(0)"  title="{l s='color9'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout10 {if $dorthemecolor=='color10' } active {/if}" id="color10"><a href="javascript:void(0)"  title="{l s='color10'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout11 {if $dorthemecolor=='color11' } active {/if}" id="color11"><a href="javascript:void(0)"  title="{l s='color11'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout12 {if $dorthemecolor=='color12' } active {/if}" id="color12"><a href="javascript:void(0)"  title="{l s='color12'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>

                                        <div class="cl-tr cl-tr-style">
                                            <div class="cl-td-l cl-td-layout cl-td-layout13 {if $dorthemecolor=='color13' } active {/if}" id="color13"><a href="javascript:void(0)"  title="{l s='color13'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                            <div class="cl-td-l cl-td-layout cl-td-layout14 {if $dorthemecolor=='color14' } active {/if}" id="color14"><a href="javascript:void(0)"  title="{l s='color14'}"><span class="cl2"></span><span class="cl1"></span></a></div>
                                        </div>
            ...
            <div class="tab-pane fade" id="topbarOption">
                <div class="tab-content-ii">
                    <form class="form-horizontal" action = "{$action}"  enctype="multipart/form-data" method="post">
                        ...
                        <div id="footer-chose-theme" class="footer-class-admin">
        ...
        <div class="tab-pane fade active in" id="dorAdvance">
            <div class="tab-content-ii">
               ...
               <div id="advance-cache-style" class="advance-class-admin hidden">
