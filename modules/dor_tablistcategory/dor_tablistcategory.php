...
class dor_tablistcategory extends Module {
    ...
    public function hookHome(){
        ...
        if($defaultTabID != -1){
            return $this->display(__FILE__, 'dor_tablistcategory.tpl', $this->getCacheId());
        }else{
            return $this->display(__FILE__, 'dor_tablistcategory_all.tpl', $this->getCacheId());
        }
    }
    ...
    public function DorCacheTablist($mainCateID, $cateID,$defaultTabID, $productTabslider){
        ...
        $fileCache = 'HomeTabListCaches-Shop'.$id_shop.'-'.$cateID;
