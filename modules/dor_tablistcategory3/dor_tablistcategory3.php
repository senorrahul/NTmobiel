...
class dor_tablistcategory3 extends Module {
    ...
    public function hookHome(){
        ...
        if($defaultTabID != -1){
            return $this->display(__FILE__, 'dor_tablistcategory3.tpl', $this->getCacheId());
        }else{
            return $this->display(__FILE__, 'dor_tablistcategory3_all.tpl', $this->getCacheId());
        }
    }
    ...
    public function DorCacheTablist3($mainCateID, $cateID,$defaultTabID, $productTabslider){
        ...
        $fileCache = 'HomeTabList3Caches-Shop'.$id_shop.'-'.$cateID;
